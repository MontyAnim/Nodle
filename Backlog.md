...
| **NDL-07** | Extracción Datos | Scrapers Procedurales (Houdini/Substance) | Scripts Python para extraer información de VOPs/SOPs de Houdini (hou) y SDNodeInfo de Substance Designer. | Baja | XL | To Do | `feature/scraper-procedural` |
| **NDL-08** | Extracción Datos | Pipeline Consolidación JSON y Lazy Loading | Unificar JSON maestro asegurando propiedades: id, name, aliases, software, context, category, inputs, outputs, color_hex, frequency_tier (1 al 3). Implementar Code Splitting / Lazy Loading en Next.js. | Alta | M | To Do | `feature/json-pipeline` |
| **NDL-09** | Lógica Core | Motor PRNG y Asignación (Reto Diario) | Algoritmo semilla UTC determinista ofuscado y minificado en cliente. Filtro a nodos de `frequency_tier == 1`. | Alta | M | To Do | `feature/daily-prng-seed` |
...
| **NDL-17** | Funcionalidad | Leaderboards Serverless | Enviar POST con hash de usuario anonimizado, ms de resolución e intentos a Momento/Tinybird/Leadr.gg. | Baja | L | To Do | `feature/serverless-leaderboards` |
...
| **BUG-01** | QA | Bug en NDL-02 | **Severidad:** Alta <br> **Pasos:** 1. Ir a / <br> 2. Ejecutar `localStorage.getItem('nodle-storage')` en la consola <br> **Esperado:** string JSON con la estructura del store <br> **Actual:** null. Store nunca importado al bundle. | Alta | S | To Do | `bugfix/bug-01` |
