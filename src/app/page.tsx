      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="mb-12 text-center flex flex-col items-center">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <h1 className="text-5xl sm:text-7xl font-bold tracking-tight text-zinc-50 drop-shadow-sm">
              {t('title')}
            </h1>
          </div>
        ...
        <div className="flex flex-col gap-12">
              ...
              <Link href="/daily/classic" className="group flex-1">
                <div className="h-full px-6 py-4 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/20 hover:border-emerald-500/40 rounded-2xl transition-all duration-300 flex flex-col items-center justify-center gap-3 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 text-sm">{t('play_classic_desc')}</p>
                  </div>
                </div>
              </Link>
              <Link href="/practice" className="group flex-1">
                <div className="h-full px-6 py-4 bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700/50 hover:border-zinc-600 rounded-2xl transition-all duration-300 flex flex-col items-center justify-center gap-3 text-center">
                  <div className="p-3 bg-zinc-700/50 rounded-full text-zinc-400 group-hover:scale-110 transition-transform">
                    <Dumbbell className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-zinc-300 font-bold text-lg mb-1">{t('practice')}</h3>
                    <p className="text-zinc-500 text-sm">{t('practice_desc')}</p>
                  </div>
                </div>
              </Link>
            </div>
          ...
          <section className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-bold text-zinc-100">{t('tiers_title')}</h2>
            </div>
          ...
          <section className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-bold text-zinc-100">{t('software_title')}</h2>
            </div>
          ...
          <section className="flex flex-col items-center text-center mt-20 p-8 rounded-3xl bg-zinc-900/50 border border-zinc-800/50">
        ...
        {/* Global Footer */}
        <footer className="mt-16 flex flex-col items-center justify-center gap-4 text-center border-t border-zinc-800/50 pt-8 pb-8 w-full max-w-4xl">
