    ...
    <main className="min-h-screen bg-background text-foreground flex flex-col p-6 sm:p-12 md:p-24 pb-32">
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="mb-12">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-zinc-400 hover:text-zinc-100 transition-colors mb-6 text-sm font-medium"
          >
            <ArrowLeft className="w-4 h-4" />
            Volver al inicio
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-zinc-50">
            Modos de Juego
          </h1>
          <p className="text-lg text-zinc-400 max-w-2xl">
            Elige tu desafío. Compite en los retos diarios con otros artistas técnicos o practica a tu propio ritmo.
          </p>
        </div>
