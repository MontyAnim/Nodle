...
export const useBlenderStore = createGameStore('nodle-storage-blender');
export const useHoudiniStore = createGameStore('nodle-storage-houdini');
export const useSubstanceStore = createGameStore('nodle-storage-substance');
export const useUnityStore = createGameStore('nodle-storage-unity');
export const useUnrealStore = createGameStore('nodle-storage-unreal');
